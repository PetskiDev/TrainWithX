...
export const PlanOwnedCard = ({ plan }: { plan: PlanPreviewWithProgress }) => {
  ...
  return (
    <Card
      className="group hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden flex flex-col h-full"
      onClick={handleClick}
    >
      ...
      <CardContent className="pt-0 flex-grow"></CardContent>
