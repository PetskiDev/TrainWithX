          ...
          {showCreator && (
            <div className="flex items-center gap-2">
              <Avatar className="h-8 w-8">
                <AvatarImage
                  src={plan.creatorAvatarUrl}
                  alt={plan.creatorUsername}
                />
                <AvatarFallback className="text-xs">
                  {plan.creatorUsername.slice(0, 2).toUpperCase()}
                </AvatarFallback>
              </Avatar>
          ...
          <div className="flex items-center gap-4 text-base text-muted-foreground mt-2">
            <div className="flex items-center gap-1">
              ...
              <span className="font-medium text-foreground">
                {Number(plan.avgRating).toFixed(1)}
              </span>
            ...
            <Badge
              ...
              } font-medium capitalize ml-auto`}
            >
              {plan.difficulty}
            </Badge>
          </div>
